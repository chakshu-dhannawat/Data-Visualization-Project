# *********************************************************************************************************************
#                                   K-MEANS CLUSTERING : INTERACTIVE VISUALIZATION     - B20AI036 & B20AI006
# *********************************************************************************************************************
...
app.layout = html.Div(children=[
    ...
    html.Div([
        # ROW 1 (TITLE)
        html.Div([
            html.H1('Visualizing K-means -- Made by Rushil and Chakshu', style = {'color' : '#4B4D55', 'font-family':'savoye LET', 'fontSize' : 30, 'fontWeight' : 100, 'textAlign' : 'center', 'marginTop':'2%', 'marginBottom':'0%'})
        ], style = {'height' : '10%', 'border-radius':10, 'borderStyle' : 'solid', 'borderWidth' : 2, 'borderColor' : 'black', 'background-color':'white'}
        ),
        ...
        html.Div([
            ...
            html.Div([
                ...
                html.Div([
                    ...
                    html.Div([
                        html.Button('GENERATE DATA', id='regenData-button', style={'width':130, 'font-size':8, 'text-align':'center', 'padding': 0}),
            ...
            ], className='three columns', style = {'height' : '90%', 'background-color':'white', 'height' : '100%', 'borderStyle' : 'solid', 'border-radius':10, 'borderWidth' : 2, 'borderColor' : 'black'}),
    ...
    ], className = 'eight columns', style = {'height':'110%'}),
